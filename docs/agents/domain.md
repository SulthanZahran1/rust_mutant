...
- **sambungapi** — the intended dogfood corpus #1: MetatechID/sambungapi, a Rust (axum + rusqlite) wire-compatible Composio impostor for Bella. Mutation testing is fully removed from sambungapi with no return conditions: the gate machinery went 2026-09-09 (PR #919) and the hand probe plus the surrounding coverage-gate roles went 2026-09-16 (decision #1110, PR #1118). rust_mutant is standalone.
...
- The sambungapi map (MetatechID/sambungapi) previously had a ticket "mutation gate" blocked by this map's completion (cross-repo body convention); that gate is gone entirely — 2026-09-09 (PR #919) removed the machinery, 2026-09-16 (decision #1110, PR #1118) removed the hand probe and gate roles with no return conditions — and this tool is standalone.
